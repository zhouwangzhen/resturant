 ...
 */
public class ExchangeGiftFragment extends SupportFragment {
    ...
    private int exchangeCredit = 100;
    ...
    public int getLayoutId() {
        return R.layout.fg_credit_exchange_gift;
    }
    ...
    private void toConvert() {
        ...
        if (exchangeCredit > 0) {
            if (userCredit >= exchangeCredit) {
                ...
                dialog.content("确定使用" + exchangeCredit + "积分兑换抵扣")
                ...
                dialog.setOnBtnClickL(
                        ...
                        new OnBtnClickL() {
                            ...
                            public void onBtnClick() {
                                ...
                                avObject.put("type", AVObject.createWithoutData("CreditsType", "5b73ed4a9f545400352900b5"));
