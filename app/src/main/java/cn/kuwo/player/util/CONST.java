...
public class CONST {
    public static final String SYSTEM_ADMIN_TEL = "13888888888";

    public static final String SYSTEM_ADMIN_PASSWORD = "13888888888";

    public static final String DEFAULT_IMAGE_URL="https://qfile.aobeef.cn/361876d35ee46349c23f.png";
